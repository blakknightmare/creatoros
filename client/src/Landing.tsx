    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-brand-50">
      ...
      <main className="flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <div className="mt-10 flex items-center gap-4">
          <Link
            to="/signup"
            className="px-6 py-3 text-sm font-semibold bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-colors shadow-sm"
          >
            Get Started Free
          </Link>
          <Link
            to="/login"
            className="px-6 py-3 text-sm font-medium text-slate-600 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors"
          >
            Sign in
          </Link>
        </div>
